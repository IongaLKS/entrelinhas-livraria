...
<link rel="stylesheet" href="/entrelinhas/public/assets/css/style.css"
<head>
<body>
<div class="container">
<div class="topbar">
...
• <a href="/entrelinhas/index.php?controller=auth&action=logout">Sair</a>
</div>
</div>
...
<a class="btn" href="/entrelinhas/index.php?controller=auth&action=dashboard">Voltar ao
Dashboard</a>
</div>
</div>
</div>
